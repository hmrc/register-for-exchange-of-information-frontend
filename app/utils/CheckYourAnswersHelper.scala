...
class CheckYourAnswersHelper(
  ...
  def whatIsTradingName: Option[SummaryListRow] =
    userAnswers.get(pages.BusinessWithoutIDNamePage) map { x =>
  ...
  def selectAddress: Option[SummaryListRow] = userAnswers.get(SelectAddressPage) map { answer =>
    toRow(
  ...
  def businessWithoutIDName: Option[SummaryListRow] = userAnswers.get(pages.BusinessWithoutIDNamePage) map { answer =>
    toRow(
  ...
  def nonUkName: Option[SummaryListRow] = userAnswers.get(pages.NonUkNamePage) map { answer =>
    toRow(
  ...
  def addressUK: Option[SummaryListRow] = userAnswers.get(pages.AddressUKPage) map { answer =>
    toRow(
  ...
  def doYouLiveInTheUK(): Option[SummaryListRow] = userAnswers.get(pages.DoYouLiveInTheUKPage) map { answer =>
    toRow(
  ...
  def nonUkNameController: Option[SummaryListRow] = userAnswers.get(pages.NonUkNamePage) map { _ =>
    toRow(
  ...
  def whatIsYourDateOfBirth: Option[SummaryListRow] = userAnswers.get(pages.WhatIsYourDateOfBirthPage) map { answer =>
    toRow(
  ...
  def dateOfBirthWithoutId: Option[SummaryListRow] = userAnswers.get(pages.DateOfBirthWithoutIdPage) map { answer =>
    toRow(
  ...
  def whatIsYourName: Option[SummaryListRow] = userAnswers.get(pages.WhatIsYourNamePage) map { answer =>
    toRow(
  ...
  def nino: Option[SummaryListRow] = userAnswers.get(pages.WhatIsYourNationalInsuranceNumberPage) map { answer =>
    toRow(
  ...
  def isThisYourBusiness: Option[SummaryListRow] = userAnswers.get(pages.IsThisYourBusinessPage) map { _ =>
    toRow(
  ...
  def businessName: Option[SummaryListRow] = userAnswers.get(pages.BusinessNamePage) map { _ =>
    toRow(
  ...
  def reporterType: Option[SummaryListRow] = userAnswers.get(pages.ReporterTypePage) map { value =>
    toRow(
  ...
  def registeredAddressInUk: Option[SummaryListRow] = userAnswers.get(pages.RegisteredAddressInUKPage) map { answer =>
    toRow(
  ...
  def doYouHaveUniqueTaxPayerReference: Option[SummaryListRow] =
    userAnswers.get(pages.DoYouHaveUniqueTaxPayerReferencePage) map { answer =>
      toRow(
  ...
  def doYouHaveNIN: Option[SummaryListRow] = userAnswers.get(pages.DoYouHaveNINPage) map { answer =>
    toRow(
  ...
  def sndContactPhone: Option[SummaryListRow] = userAnswers.get(pages.SndConHavePhonePage) map { _ =>
  ...
  def sndContactEmail: Option[SummaryListRow] = userAnswers.get(pages.SndContactEmailPage) map { answer =>
    toRow(
  ...
  def sndContactName: Option[SummaryListRow] = userAnswers.get(pages.SndContactNamePage) map { answer =>
    toRow(
  ...
  def secondContact: Option[SummaryListRow] = userAnswers.get(pages.SecondContactPage) map { answer =>
    toRow(
  ...
  def contactName: Option[SummaryListRow] = userAnswers.get(pages.ContactNamePage) map { answer =>
    toRow(
  ...
  def contactEmail: Option[SummaryListRow] = userAnswers.get(pages.ContactEmailPage) map { answer =>
    toRow(
  ...
  def individualContactEmail: Option[SummaryListRow] = userAnswers.get(pages.IndividualContactEmailPage) map { answer =>
    toRow(
      msgKey = ContactEmailPage.toString,
      value = Text(answer),
