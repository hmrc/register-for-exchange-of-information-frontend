...
trait Mappings extends Formatters with Constraints {
  ...
  protected def localDate(invalidKey: String,
    ...
    of(new LocalDateFormatter(invalidKey, allRequiredKey, twoRequiredKey, requiredKey, maxDateKey, minDateKey, maxDate, minDate, args))
  ...
  protected def validatedFixedLengthText(requiredKey: String,
                                         invalidKey: String,
                                         lengthKey: String,
                                         regex: String,
                                         length: Int,
