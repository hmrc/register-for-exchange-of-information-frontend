...
class Navigator @Inject() () {
  ...
  private val normalRoutes: Page => UserAnswers => Call = {
    ...
    case ContactEmailPage       => _ => routes.IsContactTelephoneController.onPageLoad(NormalMode)
  ...
  private val checkRouteMap: Page => UserAnswers => Call = {
    ...
    case ContactEmailPage       => _ => routes.IsContactTelephoneController.onPageLoad(CheckMode)
