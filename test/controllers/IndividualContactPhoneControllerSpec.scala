...
class IndividualContactPhoneControllerSpec extends ControllerSpecBase {
  ...
  lazy val loadRoute   = routes.IndividualContactPhoneController.onPageLoad(NormalMode, MDR).url
  lazy val submitRoute = routes.IndividualContactPhoneController.onSubmit(NormalMode, MDR).url
