...
class DoYouHaveNINControllerSpec extends ControllerNoDataSpecBase { // TODO replace with ControllerSpecBase when actual flow is ready

  lazy val loadRoute   = routes.DoYouHaveNINController.onPageLoad(NormalMode, MDR).url
  lazy val submitRoute = routes.DoYouHaveNINController.onSubmit(NormalMode, MDR).url
