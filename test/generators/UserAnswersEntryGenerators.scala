...
trait UserAnswersEntryGenerators extends PageGenerators with ModelGenerators {
  ...
  implicit lazy val arbitraryCheckYourAnswersUserAnswersEntry: Arbitrary[(pages.CheckYourAnswersPage.type, JsValue)] =
    Arbitrary {
      for {
        page  <- arbitrary[pages.CheckYourAnswersPage.type]
